...
const database = 'mongodb://localhost/resto-hub';
...
restaurant_model_1.default.create(restaurantData)
    .then(() => console.log('Restaurants successfully created'))
    .catch(() => console.log('Error creating restaurants'));
